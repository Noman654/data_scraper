...
def get_download_links(item_url, format='PDF'):
    ...
    if entry_div:
        for a in entry_div.find_all('a', href=True):
            if format in a['href']:  # Check if format is in the href link
...
async def process_item_async(item_url):
    ...
    async with aiohttp.ClientSession() as session:
        for link in download_links:
            file_path = await download_file(session, link, output_folder, item_name, link)
            if file_path:
...
def main():
    item_urls = [
         "https://www.sanskritebooks.org/2013/04/anandashram-sanskrit-series-anandashram-samskrita-granthavali/",
       "https://www.sanskritebooks.org/2013/02/trivandrum-sanskrit-series-anantasayana-samskrita-granthavali/",
       "https://www.sanskritebooks.org/2015/12/bibliotheca-indica-series/",
       "https://www.sanskritebooks.org/2011/08/complete-collection-of-kavyamala-series-of-books-of-nirnaya-sagar-press/",
       "https://www.sanskritebooks.org/201106/complete-works-of-kalidasa/"
    ]
